...
app/
  ...
  auth/confirm/route.ts   Route Handler que recibe el link del email de confirmación (código PKCE) y crea la sesión server-side (ver sección Autenticación)
